"""Standard-library transports for xdebug/xcov JSON APIs."""
...
def resolve_tool(name: str, root: Optional[Union[str, os.PathLike]] = None) -> Path:
    """Resolve a repository tool while allowing XVERIF_HOME overrides."""
    if root is None:
        configured = os.environ.get("XVERIF_HOME")
...
class StdioTransport:
    """Maintain one SDK-free JSONL process for stateful xdebug/xcov work."""
