...
from xverif_sdk import (CoverageRun, StdioTransport, XcovClient,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--tool", default=str(resolve_tool("xcov")))
    ...
    parser.add_argument("--fake", action="store_true",
                        help="use xcov's built-in fake backend for all runs")
...
def main(argv=None) -> int:
    ...
    with StdioTransport(
        args.tool, protocol="xcov-stdio-loop", api_version="xcov.v1",
