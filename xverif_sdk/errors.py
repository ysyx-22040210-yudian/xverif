...
class XverifSdkError(RuntimeError):
    """Base class for SDK errors."""


class ToolInvocationError(XverifSdkError):
...
class ProtocolError(XverifSdkError):
    """The JSON/JSONL transport contract was violated."""


class ToolResponseError(XverifSdkError):
    ...
    def __init__(self, response: Json) -> None:
        ...
        self.detail = error
        message = str(error.get("message", "xverif tool request failed"))
