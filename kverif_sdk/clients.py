"""Typed convenience clients over the stable kdebug/kcov JSON contracts."""
...
class KdebugClient(_BaseClient):
    ...
    def session(self, name: str, *, fsdb: Optional[str] = None,
                daidir: Optional[str] = None,
                args: Optional[Mapping[str, Any]] = None) -> Iterator["KdebugClient"]:
...
class KcovClient(_BaseClient):
    ...
    def session(self, name: str, vdb: str, *, fake: bool = False,
                args: Optional[Mapping[str, Any]] = None) -> Iterator["KcovClient"]:
