...
def analyze_wave_window(client: KdebugClient, signals: Iterable[str], *,
                        start: str, end: str,
...
def trace_module_connections(client: KdebugClient, signals: Iterable[str], *,
                             max_depth: int = 4,
    ...
    return {
        "schema": "kverif.sdk.module-connections.v1",
        "summary": {
...
def analyze_coverage_convergence(client: KcovClient, runs: Sequence[CoverageRun], *,
    ...
    return {
        "schema": "kverif.sdk.coverage-convergence.v1",
        "summary": {
