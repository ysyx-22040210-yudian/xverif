...
|---|---|---|---|---|---|---|---|---|---|---|---|
| glm-4.7 | with_xdebug | 18 | 0 | 6 | 0 | 0 | 12 | 0 | 0.0% |  | 0 |
| glm-4.7 | without_xdebug | 6 | 0 | 6 | 0 | 0 | 0 | 0 | 0.0% |  | 4251201 |
| gpt-5.5 | with_xdebug | 16 | 12 | 4 | 0 | 0 | 0 | 0 | 75.0% | 202.47s | 73362 |
| gpt-5.5 | without_xdebug | 16 | 11 | 5 | 0 | 0 | 0 | 0 | 68.8% | 149.27s | 74984 |
| qwen3.6-35b | with_xdebug | 16 | 7 | 9 | 0 | 0 | 0 | 0 | 43.8% | 19.75s | 5281314 |
| qwen3.6-35b | without_xdebug | 16 | 5 | 11 | 0 | 0 | 0 | 0 | 31.2% | 16.20s | 6601624 |

## 按 bug 域拆分

| bug_domain | model_id | group | Trial 数 | PASS | 未修通（TIMEOUT） | 证据缺失 | 规则违规 | 限流待重试 | 基础设施异常 | 有效成功率 | PASS 中位耗时 | Token 中位数 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| env | gpt-5.5 | with_xdebug | 3 | 3 | 0 | 0 | 0 | 0 | 0 | 100.0% | 37.43s | 12357 |
| env | gpt-5.5 | without_xdebug | 3 | 3 | 0 | 0 | 0 | 0 | 0 | 100.0% | 37.20s | 12366 |
| env | qwen3.6-35b | with_xdebug | 3 | 3 | 0 | 0 | 0 | 0 | 0 | 100.0% | 9.18s | 7430 |
| env | qwen3.6-35b | without_xdebug | 3 | 3 | 0 | 0 | 0 | 0 | 0 | 100.0% | 7.86s | 4640 |
| mixed | gpt-5.5 | with_xdebug | 3 | 2 | 1 | 0 | 0 | 0 | 0 | 66.7% | 277.75s | 66682 |
| mixed | gpt-5.5 | without_xdebug | 3 | 2 | 1 | 0 | 0 | 0 | 0 | 66.7% | 212.74s | 56698 |
| mixed | qwen3.6-35b | with_xdebug | 3 | 0 | 3 | 0 | 0 | 0 | 0 | 0.0% |  | 11567509 |
| mixed | qwen3.6-35b | without_xdebug | 3 | 0 | 3 | 0 | 0 | 0 | 0 | 0.0% |  | 11244671 |
| rtl | glm-4.7 | with_xdebug | 18 | 0 | 6 | 0 | 0 | 12 | 0 | 0.0% |  | 0 |
| rtl | glm-4.7 | without_xdebug | 6 | 0 | 6 | 0 | 0 | 0 | 0 | 0.0% |  | 4251201 |
| rtl | gpt-5.5 | with_xdebug | 10 | 7 | 3 | 0 | 0 | 0 | 0 | 70.0% | 240.16s | 182178 |
| rtl | gpt-5.5 | without_xdebug | 10 | 6 | 4 | 0 | 0 | 0 | 0 | 60.0% | 142.34s | 242050 |
| rtl | qwen3.6-35b | with_xdebug | 10 | 4 | 6 | 0 | 0 | 0 | 0 | 40.0% | 25.66s | 5281314 |
| rtl | qwen3.6-35b | without_xdebug | 10 | 2 | 8 | 0 | 0 | 0 | 0 | 20.0% | 17.24s | 6645026 |

## 按 benchmark 层拆分

| benchmark_layer | model_id | group | Trial 数 | PASS | 未修通（TIMEOUT） | 证据缺失 | 规则违规 | 限流待重试 | 基础设施异常 | 有效成功率 | PASS 中位耗时 | Token 中位数 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| fullchip | glm-4.7 | with_xdebug | 13 | 0 | 1 | 0 | 0 | 12 | 0 | 0.0% |  | 0 |
| fullchip | glm-4.7 | without_xdebug | 1 | 0 | 1 | 0 | 0 | 0 | 0 | 0.0% |  | 2471107 |
| fullchip | gpt-5.5 | with_xdebug | 9 | 5 | 4 | 0 | 0 | 0 | 0 | 55.6% | 240.16s | 66682 |
| fullchip | gpt-5.5 | without_xdebug | 9 | 4 | 5 | 0 | 0 | 0 | 0 | 44.4% | 277.18s | 295273 |
| fullchip | qwen3.6-35b | with_xdebug | 9 | 2 | 7 | 0 | 0 | 0 | 0 | 22.2% | 87.81s | 11422941 |
| fullchip | qwen3.6-35b | without_xdebug | 9 | 2 | 7 | 0 | 0 | 0 | 0 | 22.2% | 20.59s | 6634975 |
| generated_wrapper | glm-4.7 | with_xdebug | 2 | 0 | 2 | 0 | 0 | 0 | 0 | 0.0% |  | 5282960 |
| generated_wrapper | glm-4.7 | without_xdebug | 2 | 0 | 2 | 0 | 0 | 0 | 0 | 0.0% |  | 4731892 |
| generated_wrapper | gpt-5.5 | with_xdebug | 2 | 2 | 0 | 0 | 0 | 0 | 0 | 100.0% | 199.31s | 155109 |
| generated_wrapper | gpt-5.5 | without_xdebug | 2 | 2 | 0 | 0 | 0 | 0 | 0 | 100.0% | 118.51s | 103086 |
| generated_wrapper | qwen3.6-35b | with_xdebug | 2 | 2 | 0 | 0 | 0 | 0 | 0 | 100.0% | 24.66s | 36770 |
| generated_wrapper | qwen3.6-35b | without_xdebug | 2 | 1 | 1 | 0 | 0 | 0 | 0 | 50.0% | 16.20s | 6246088 |
| real_rtl_it | glm-4.7 | with_xdebug | 3 | 0 | 3 | 0 | 0 | 0 | 0 | 0.0% |  | 3743367 |
| real_rtl_it | glm-4.7 | without_xdebug | 3 | 0 | 3 | 0 | 0 | 0 | 0 | 0.0% |  | 4772098 |
| real_rtl_it | gpt-5.5 | with_xdebug | 4 | 4 | 0 | 0 | 0 | 0 | 0 | 100.0% | 218.09s | 93960 |
| real_rtl_it | gpt-5.5 | without_xdebug | 4 | 4 | 0 | 0 | 0 | 0 | 0 | 100.0% | 109.63s | 48134 |
| real_rtl_it | qwen3.6-35b | with_xdebug | 4 | 2 | 2 | 0 | 0 | 0 | 0 | 50.0% | 31.09s | 4544770 |
| real_rtl_it | qwen3.6-35b | without_xdebug | 4 | 1 | 3 | 0 | 0 | 0 | 0 | 25.0% | 18.28s | 6611675 |
| real_rtl_ut | gpt-5.5 | with_xdebug | 1 | 1 | 0 | 0 | 0 | 0 | 0 | 100.0% | 37.43s | 17518 |
| real_rtl_ut | gpt-5.5 | without_xdebug | 1 | 1 | 0 | 0 | 0 | 0 | 0 | 100.0% | 37.20s | 12366 |
| real_rtl_ut | qwen3.6-35b | with_xdebug | 1 | 1 | 0 | 0 | 0 | 0 | 0 | 100.0% | 9.18s | 7430 |
| real_rtl_ut | qwen3.6-35b | without_xdebug | 1 | 1 | 0 | 0 | 0 | 0 | 0 | 100.0% | 7.86s | 4640 |

## 逐 Case 结果

| Case | Bug 域 | 层级 | 子系统 | 模型 | 使用 xdebug | 不使用 xdebug |
|---|---|---|---|---|---|---|
