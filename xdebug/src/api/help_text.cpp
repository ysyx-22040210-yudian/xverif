...
const char* fallback_help_text() {
    return
        "xdebug - unified xdebug parameter and protocol interface\n"
        "=======================================================\n\n"
        "Usage\n"
        "-----\n"
        "  xdebug -h\n"
        ...
        "  xdebug value-at --fsdb <waves.fsdb>|--session <id> --signal <sig> --time <time>\n"
        "      Query one signal value.\n\n"
        "  xdebug trace-driver --daidir <simv.daidir>|--session <id> --signal <sig>\n"
        "      Query static RTL driver evidence from the elaboration database.\n\n"
        "  xdebug active-driver --daidir <simv.daidir> --fsdb <waves.fsdb> --signal <sig> --time <time>\n"
